...
bot.dialog('/', function(session) {
    ...
    if((typeof session.message.address.conversation.isGroup !== 'undefined') && (ession.message.address.conversation.isGroup == true)) utils.saveLastGroupChannelAddress(session);
